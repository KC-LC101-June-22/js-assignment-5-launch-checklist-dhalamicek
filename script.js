...
//since inputs are all classified as text, do I need to change type of fuelLevel and cargoMass into numbers?
   ...
   //is that how I get the inputs in the function as parameters? what is the list parameter referring to??? should document be form or document?
//if preventDefault is to go in this file, where do I put it and how since it depends on the function?
